...
Task.create! :name => "agriculture"
Task.create! :name => "sfds"
Task.create! :name => "ytjkk"
Task.create! :name => "yhb"
Task.create! :name => "rff"
Task.create! :name => "qasw"
Task.create! :name => "wse"
Task.create! :name => "yjg"
